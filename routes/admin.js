...
//comentarios
router.get('/reviews', [validarJWT, validarCampos], aCourses.getCourseReviews);
router.put('/reviews',[validarJWT, validarCampos], aCourses.putCourseReviews);
...
//BANNERS
router.get('/banner', settings.getBanners);
